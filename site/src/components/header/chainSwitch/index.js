      ...
      {show && (
        <Options>
          <ChainGroupWrapper>
            ...
            <ChainGroupItem
              href={"https://contracts.5irescan.ink"}
              target={"_blank"}
            >
              <EdgewareDark style={{ width: '20px', height: '20px' }} />
              <ChainGroupItemName>
                <span>{"ink-Explorer"}</span>
                <ChainGroupItemCaretWrapper>
                  <CaretRightIcon />
                </ChainGroupItemCaretWrapper>
              </ChainGroupItemName>
			...
			<ChainGroupItem
              href={"https://staking.5irescan.ink"}
              target={"_blank"}
            >
              <EdgewareDark style={{ width: '20px', height: '20px' }} />
              <ChainGroupItemName>
                <span>{"5ire-Staking"}</span>
                <ChainGroupItemCaretWrapper>
                  <CaretRightIcon />
                </ChainGroupItemCaretWrapper>
              </ChainGroupItemName>
